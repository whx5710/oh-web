...
/** @type {import("/home/finn/data/workspace/oh-web/packages/@core/base/shared/src/store.js")} */
const _module = await jiti.import("/home/finn/data/workspace/oh-web/packages/@core/base/shared/src/store.ts");
