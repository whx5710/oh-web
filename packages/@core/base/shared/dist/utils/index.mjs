...
/** @type {import("/home/finn/data/workspace/oh-web/packages/@core/base/shared/src/utils/index.js")} */
const _module = await jiti.import("/home/finn/data/workspace/oh-web/packages/@core/base/shared/src/utils/index.ts");
...
export const maxSize = _module.maxSize;
