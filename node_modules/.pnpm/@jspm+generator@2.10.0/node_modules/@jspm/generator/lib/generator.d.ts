...
export declare class Generator {
     ...
     */
    constructor({ baseUrl, mapUrl, rootUrl, inputMap, env, defaultProvider, defaultRegistry, customProviders, providers, resolutions, cache, fetchOptions, packageConfigs, ignore, commonJS, typeScript, system, integrity, fetchRetries, providerConfig, preserveSymlinks, customResolver, flattenScopes, combineSubpaths, scopedLink, traceCache }?: GeneratorOptions);
    /**
