...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/vite-config": "/home/finn/data/workspace/oh-web/internal/vite-config"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/home/finn/data/workspace/oh-web/internal/vite-config/src/index.js")} */
const _module = await jiti.import("/home/finn/data/workspace/oh-web/internal/vite-config/src/index.ts");
