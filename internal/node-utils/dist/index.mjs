...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/node-utils": "/home/finn/data/workspace/oh-web/internal/node-utils"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/home/finn/data/workspace/oh-web/internal/node-utils/src/index.js")} */
const _module = await jiti.import("/home/finn/data/workspace/oh-web/internal/node-utils/src/index.ts");
