...
// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/button/src/button.js
      ...
      if (dropdownsSlot || downBtnList.length) {
        ...
        return h("div", {
          ...
          routerLink ? h(resolveComponent("router-link"), Object.assign({
            ...
            disabled: btnDisabled || loading,
            onClick: clickTargetEvent
          }, btnOns), renderContent().concat(showDropdownIcon ? [
            h("i", {
              class: `vxe-button--dropdown-arrow ${getIcon().BUTTON_DROPDOWN}`
            })
          ] : [])),
          h(Teleport, {
            ...
            h("div", Object.assign({ ref: refBtnPanel, class: ["vxe-button--dropdown-panel", ppClassName ? import_xe_utils.default.isFunction(ppClassName) ? ppClassName({ $button: $xeButton }) : ppClassName : "", {
              [`size--${vSize}`]: vSize,
...
//# sourceMappingURL=chunk-C4VNHEW2.js.map
