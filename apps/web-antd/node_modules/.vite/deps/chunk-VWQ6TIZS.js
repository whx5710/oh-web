import {
  button_default
} from "./chunk-C4VNHEW2.js";
import {
  getEventTargetNode,
  getTpImg,
  initTpImg,
  toCssUnit
} from "./chunk-JAWCYRZY.js";
import {
  getSlotVNs
} from "./chunk-24WZ3DLP.js";
import {
  defineVxeComponent,
  dynamicApp,
  errLog,
  warnLog
} from "./chunk-6HY6Z57T.js";
import {
  VxeUI,
  createEvent,
  getConfig,
...
// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/upload/src/upload.js
var import_xe_utils2 = __toESM(require_xe_utils());

// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/upload/src/util.js
...
var upload_default = defineVxeComponent({
  ...
  setup(props, context) {
          ...
          slots: {
            default() {
              ...
              return h("div", Object.assign({ ref: refPopupElem, class: ["vxe-upload--more-popup", {
                ...
                }, dragPlaceholder || getI18n("vxe.upload.dragPlaceholder")) : renderEmptyElement($xeUpload)
              ]);
            }
          },
          onShow() {
    ...
    const rendeFileMode = () => {
      ...
      if (import_xe_utils2.default.isNumber(maxCount) && fileList.length > maxCount) {
        isMoreMax = true;
      ...
      return h("div", {
        ...
        h("div", {
          ...
          showMoreButton && overMaxNum ? h("div", {
            ...
            h(button_default, {
              mode: "text",
              content: moreButtonText ? import_xe_utils2.default.isFunction(moreButtonText) ? moreButtonText({ $upload: $xeUpload, options: fileList }) : import_xe_utils2.default.toFormatString(moreButtonText, [fileList.length]) : getI18n(isMoreMax && isMiniMore ? "vxe.upload.moreFileBtnText" : "vxe.upload.moreBtnText", [fileList.length]),
              status: "primary",
        ...
        dragSort ? h(TransitionGroup, {
          ...
          default: () => renderImageItemList(currList, false).concat([
            showMoreButton && overMaxNum ? h("div", {
              ...
              h(button_default, {
                mode: "text",
                content: moreButtonText ? import_xe_utils2.default.isFunction(moreButtonText) ? moreButtonText({ $upload: $xeUpload, options: fileList }) : import_xe_utils2.default.toFormatString(moreButtonText, [fileList.length]) : getI18n(isMoreMax && isMiniMore ? "vxe.upload.moreImgBtnText" : "vxe.upload.moreBtnText", [fileList.length]),
                status: "primary",
                onClick: handleMoreEvent
              })
            ]) : renderEmptyElement($xeUpload),
    ...
    onBeforeUnmount(() => {
      ...
      import_xe_utils2.default.assign(reactData, createReactData());
      import_xe_utils2.default.assign(internalData, createInternalData());
    });
    updateFileList();
...
// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/upload/index.js
...
//# sourceMappingURL=chunk-VWQ6TIZS.js.map
