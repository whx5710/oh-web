import {
  ...
  tableProps,
  table_default
} from "./chunk-OXFT6R3F.js";
import {
  getDomNode,
  getOffsetHeight,
  getPaddingTopBottomSize,
  toCssUnit
} from "./chunk-LRQGJ2XT.js";
import {
  toolbar_default
} from "./chunk-JMW2HWX6.js";
import {
  defineVxeComponent,
  errLog,
  getSlotVNs,
  warnLog
} from "./chunk-3US32CY6.js";
import {
  getLastZIndex,
  isEnableConf,
  nextZIndex
} from "./chunk-YH6WJWZQ.js";
import {
  VxeUI,
  require_xe_utils
} from "./chunk-AQ3EN4SI.js";
import {
  computed,
  h,
  nextTick,
...
// ../../node_modules/.pnpm/vxe-table@4.17.48_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-table/es/grid/src/grid.js
var import_xe_utils = __toESM(require_xe_utils());

// ../../node_modules/.pnpm/vxe-table@4.17.48_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-table/es/grid/src/props.js
var { getConfig } = VxeUI;
...
// ../../node_modules/.pnpm/vxe-table@4.17.48_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-table/es/grid/src/emits.js
var gridEmits = [
  ...tableEmits,
  "page-change",
  "form-submit",
              ...
              return Promise.all([
                ...
                if (rest) {
                  ...
                  if (pagerConfig && isEnableConf(pagerOpts)) {
                    ...
                    const total = (import_xe_utils.default.isFunction(totalProp) ? totalProp(reParams) : import_xe_utils.default.get(rest, totalProp || "page.total")) || 0;
                    tablePage.total = import_xe_utils.default.toNumber(total);
                    const resultProp = resConfigs.result;
                    tableData = (import_xe_utils.default.isFunction(resultProp) ? resultProp(reParams) : import_xe_utils.default.get(rest, resultProp || "result")) || [];
                    ...
                    if (import_xe_utils.default.isArray(rest)) {
                      tableData = rest;
                    } else if (listProp) {
                      tableData = (import_xe_utils.default.isFunction(listProp) ? listProp(reParams) : import_xe_utils.default.get(rest, listProp)) || [];
                    }
                  }
                  if (showFooter) {
                    const fdProp = resConfigs.footerData;
                    const footerList = fdProp ? import_xe_utils.default.isFunction(fdProp) ? fdProp(reParams) : import_xe_utils.default.get(rest, fdProp) : [];
                    if (import_xe_utils.default.isArray(footerList)) {
          ...
          case "queryFooter": {
            ...
            if (qfMethods) {
              ...
              return Promise.resolve((beforeQueryFooter || qfMethods)(commitParams, ...args)).then((rest) => {
                reactData.footerData = import_xe_utils.default.isArray(rest) ? rest : [];
                if (afterQueryFooter) {
    ...
    const gridPrivateMethods = {
      ...
      triggerToolbarCommitEvent(params, evnt) {
        ...
        if (code) {
          ...
          const rest = $xeGrid.commitProxy(params, evnt).then((rest2) => {
            if (rest2 && rest2.status && ["query", "reload", "delete", "save"].includes(code)) {
              $xeGrid.dispatchEvent(code === "delete" || code === "save" ? `proxy-${code}` : "proxy-query", Object.assign(Object.assign({}, rest2), { isReload: code === "reload" }), evnt);
            }
          });
          internalData.uFoot = false;
          if (isUf) {
...
// ../../node_modules/.pnpm/vxe-table@4.17.48_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-table/es/grid/index.js
...
//# sourceMappingURL=chunk-MF6424LO.js.map
