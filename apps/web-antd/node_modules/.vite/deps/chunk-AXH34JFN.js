...
// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/number-input/src/number-input.js
  ...
  setup(props, context) {
    ...
    const computeInpMaxLength = computed(() => {
      ...
      if (!eqEmptyValue(min) && !eqEmptyValue(max)) {
        return `${max}`.length + (type === "integer" ? 0 : digitsValue + 1) + (import_xe_utils.default.toNumber(min) >= 0 ? 0 : 1);
      }
      if (maxLength || maxlength) {
        return import_xe_utils.default.toNumber(maxLength || maxlength);
      }
      return maxDefLen;
    });
    ...
    const renderPrefixIcon = () => {
      ...
      return prefixSlot || preIcon || sufContent ? h("div", {
        ...
        h("div", {
          ...
          }, `${sufContent}`) : renderEmptyElement($xeNumberInput)
        ])
      ]) : renderEmptyElement($xeNumberInput);
    };
...
//# sourceMappingURL=chunk-AXH34JFN.js.map
