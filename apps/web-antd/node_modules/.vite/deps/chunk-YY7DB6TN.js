...
// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/input/src/input.js
var import_xe_utils2 = __toESM(require_xe_utils());

// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/date-panel/src/util.js
...
var parseDateValue = (val, type, options) => {
  ...
  if (val) {
    ...
    if (import_xe_utils.default.isNumber(val) || /^[0-9]{10,15}$/.test(`${val}`)) {
      return new Date(Number(val));
    }
    if (import_xe_utils.default.isString(val)) {
      return import_xe_utils.default.toStringDate(import_xe_utils.default.last(val.split(",")), valueFormat);
    }
...
function parseDateObj(val, type, options) {
  ...
  if (import_xe_utils.default.isValidDate(dValue)) {
    ...
    if (labelFormat && type === "week") {
      ...
      const W = import_xe_utils.default.getYearWeek(dValue, firstDay);
...
function getDateByCode(code, val, type, options) {
  ...
  return {
    value: dValue ? import_xe_utils.default.toDateString(dValue, valueFormat) : ""
  };
}
...
function getRangeDateByCode(code, val, type, options) {
  const { valueFormat, firstDay } = options;
  if (import_xe_utils.default.isArray(val)) {
    val = val.join("");
  }
  ...
  const startValue = sValue ? import_xe_utils.default.toDateString(sValue, valueFormat) : "";
  const endValue = eValue ? import_xe_utils.default.toDateString(eValue, valueFormat) : "";
  return {
    startValue,
    endValue
  };
...
var input_default = defineVxeComponent({
  ...
  setup(props, context) {
    ...
    const renderPrefixIcon = () => {
      ...
      return prefixSlot || preIcon || sufContent ? h("div", {
        ...
        h("div", {
          ...
          }, `${sufContent}`) : renderEmptyElement($xeInput)
        ])
      ]) : renderEmptyElement($xeInput);
    };
    const renderSuffixIcon = () => {
      ...
      return isClearable || suffixSlot || sufIcon || sufContent || isExtraBtn ? h("div", {
...
//# sourceMappingURL=chunk-YY7DB6TN.js.map
