...
// ../../node_modules/.pnpm/vxe-pc-ui@4.12.35_vue@3.5.27_typescript@5.9.3_/node_modules/vxe-pc-ui/es/select/src/select.js
...
var select_default = defineVxeComponent({
  ...
  setup(props, context) {
    ...
    const computeBtnTransfer = computed(() => {
      ...
      if (import_xe_utils.default.isBoolean(popupOpts.transfer)) {
    ...
    const updateZIndex = () => {
      ...
      if (customZIndex) {
        reactData.panelIndex = import_xe_utils.default.toNumber(customZIndex);
    ...
    const handleSearchEvent = () => {
      ...
      if (remote && qyMethod && remoteOpts.enabled) {
        ...
        Promise.resolve(qyMethod({ $select: $xeSelect, searchValue, value: modelValue })).then(() => nextTick()).catch(() => nextTick()).finally(() => {
          reactData.searchLoading = false;
          handleOption();
          updateYData();
        });
    ...
    const renderVN = () => {
      ...
      return h("div", {
        ...
        h(Teleport, {
          ...
          h("div", {
            ref: refOptionPanel,
            class: ["vxe-table--ignore-clear vxe-select--panel", ppClassName ? import_xe_utils.default.isFunction(ppClassName) ? ppClassName({ $select: $xeSelect }) : ppClassName : "", {
              [`size--${vSize}`]: vSize,
...
//# sourceMappingURL=chunk-P2A2O5K4.js.map
